  ...
  renderRight = () => {
    ...
    if (title === 'Title') {
      return [
        ...
        <ChatButton key="basket-title" navigation={navigation} isWhite={white} />
      ];
    }
    ...
    switch (title) {
      ...
      case 'Account':
        return [
          ...
          <ChatButton key="basket-deals" navigation={navigation} />
        ];
      case 'Product':
        return [
          <BellButton key="chat-profile" navigation={navigation} isWhite={white} />,
  ...
  renderSearch = () => {
    ...
    return (
      <Input
        ...
        color="black"
        style={styles.search}
        placeholder="What are you looking for on Tinkoko?"
